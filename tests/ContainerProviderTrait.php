...
trait ContainerProviderTrait
{
    ...
    {
        $config = ['best_it_kitchensink' => ['data_provider' => 'bestit_kitchensink.data_provider.test_fake', 'template' => 'kitchensink/index.html.twig']];
        return $config;
    }
    /**
     ...
     * @return ContainerBuilder
     */
    public function getFullyLoadedContainer($config = null)
    {
        if ($config === null) {
